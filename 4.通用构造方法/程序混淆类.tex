...
\begin{center}
\begin{tikzpicture}
    \node [name=C, textnode] {\includegraphics[width=1.2in]{插图/code.png}};
    \node [name=OC, textnode, right of=C, xshift=16em] {\includegraphics[width=1.2in]{插图/obf.png}};
...
\begin{center}
\begin{tikzpicture}
    \node [name=adv, textnode] {\includegraphics[width=0.5in]{插图/adversary.png}};
    \node [name=challenger, textnode, right of = adv, xshift=18em] 
        {\includegraphics[width=0.5in]{插图/challenger.png}}; 
